...
Mesh create_sphere(float radius = 0.5f, int segments = 32, int rings = 16);
Mesh create_cylinder(float radius = 0.5f, float height = 1.0f, int segments = 32);
Mesh create_cone(float radius = 0.5f, float height = 1.0f, int segments = 32);
Mesh create_torus(float major_r = 0.5f, float minor_r = 0.2f, int major_seg = 32, int minor_seg = 16);
