...
### Recommande — C++ (v2.2)
**[Telecharger OCP v2.2 (C++)](https://github.com/SaikiHaiku/Object-Creation-Project---KWS/releases/download/v2.2/OCP-v2.2-CPP.zip)** — Executable Windows natif, 4 Mo. Extraire le zip et lancer `OCP.exe`.
